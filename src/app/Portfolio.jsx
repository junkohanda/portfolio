...
const portfolioData = {
  name: "Junko",
  title: "Data Analyst",
  tagline: "15年の臨床経験 × データ分析で、\n医療と社会の課題を解く",
  summary:
    "総合病院で15年以上、病棟・看護教育・外来・管理と多領域で看護師として勤務。主任看護師としてチームマネジメントや新人指導にも携わる中で、現場の課題をデータで解決したいという想いからデータ分析の学習を開始。Python・SQL・機械学習を習得し、医療ドメイン知識を活かしたデータ分析プロジェクトに取り組んでいます。",
  strengths: [
    {
      icon: "🏥",
      title: "ドメイン知識",
  ...
  projects: [
    ...
    },
    {
      ...
      impact:
        "データ分析が受診前段階でのリスク可視化・行動変容の促進に活用できる可能性を示した",
      color: "#0891B2",
    ...
    {
      id: 5,
      title: "駐妻キャリア支援コミュニティ CCSP",
      tags: ["コミュニティ設計", "課題発見・構造化", "企画・運営", "ボランティア活動"],
      source: "個人活動（発起人）",
      question:
        "シンガポール在住の駐妻が、ビザ制約の中でも帰国後に「やっていた」と語れるキャリア資産を積める場を作れないか？",
      approach:
        "DP（配偶者ビザ）では現地就労が原則不可という構造的課題を整理 → ボランティア・プロボノ活動であれば制限に抵触しないと設計 → 自身も当事者として、約800名のシンガポール駐妻コミュニティ内に「キャリア部」を立ち上げ → イベント企画・スキルのシェア・調査レポート・アンケート分析を活動の柱に設定し、帰国後に語れる成果物を残す仕組みを意識して構築",
      insight:
        "「働けない」と「実績が作れない」は別問題。当事者が発起人であることが信頼と参加を生み、初回交流会から20名が集まった。コアメンバー10名が定着し、コミュニティとして自走し始めている",
      impact:
        "交流会1回開催・参加者20名、コアメンバー10名。第2回交流会・自己理解イベントをそれぞれ企画中。セミラティス・キャリアマーク（株式会社ノヴィータ）等との連携・コラボも予定",
      color: "#EA580C",
      chartData: [3, 8, 20, 22, 25, 30, 35],
      github: null,
    },
    {
      id: 6,
      title: "まいにち学習スタンプ",
      tags: ["AI活用開発 (Codex)", "JavaScript", "EdTech", "子ども向けUX"],
      source: "個人開発",
      question:
        "「やりなさい！」と言わずに、子どもの学習継続を支援できないか？親の監視ではなく、「できたね」という達成感だけが残る仕組みを作れないか？",
      approach:
        "子どもが自分でスタンプを押すだけのシンプルな学習記録アプリをAI活用開発（Codex）で制作。科目選択→スタンプ→カレンダーで記録が残る設計。親が管理するのではなく、子ども自身が「見える化」できることを重視。連続日数・週次レポート・バッジによるモチベーション維持機能も実装",
      insight:
        "機能を絞ることで、子どもが自発的に使える設計になる。「できた」の積み上げが学習継続の鍵。ひらがな/漢字表示の切り替えにより、就学前後どちらの子どもにも対応",
      impact:
