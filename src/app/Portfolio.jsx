...
const portfolioData = {
  ...
  projects: [
    ...
    {
      id: 4,
      title: "看護師向け総合サポートアプリ（プロトタイプ）",
      tags: ["要件定義・機能設計", "AI活用実装 (Claude)", "プロトタイプ"],
      source: "個人開発",
      question: "看護師の日常業務（シフト管理・学習・ToDo）を一つのアプリで効率化できないか？",
      approach:
        "現場経験に基づく要件定義・機能設計を自ら行い、AIを活用して実装。2交代/3交代制対応のシフトカレンダー、診療科別階層カテゴリ付き勉強ノート、復習リマインダー→ToDo自動連携、最新看護情報取得機能など、看護師の日常業務を網羅する機能を設計",
      insight:
        "AIを活用した開発により、非エンジニアでもアイデアを形にできることを実証。診療科別カテゴリ（30科以上）や3交代制対応など、臨床経験がなければ設計できない粒度の機能仕様が最大の価値",
      impact:
        "シフト・学習・タスク管理を統合した看護師特化型アプリのプロトタイプを実現。今後は医療情報サイトとの連携や、看護師同士が交流できるコミュニティ機能の追加を構想中",
      color: "#059669",
      chartData: [20, 35, 50, 60, 70, 78, 85],
      github: "https://github.com/junkohanda/nurse-support-app",
    },
  ],
};
